...
export function AddCandidateWidget(props: AddCandidateWidgetProps) {
    ...
    const candidateIds = posData?.data?.map((candidate) => candidate.id)
    ...
    const filteredCandidates = data?.data?.filter(
        (candidate: CandidateUpdate) => {
            ...
            const isNotInEventData = !candidateIds?.includes(candidate.id)
    ...
    const handleAddCandidate = async (candidateId: CandidateId) => {
        const success = await positionCandidateApi.create({
    ...
    return (
        <div data-testid="add-candidate-widget" className={styles.container}>
