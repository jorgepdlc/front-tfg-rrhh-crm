        ...
        <header className={styles.header}>
            <nav>
                <div className={styles.paths}>
                    <Link href="/" className={styles.path}>
                    ...
                    >
                        ...
                        <div className="hidden lg:block pl-1">Users</div>
                    </Link>
                    <Link
                        href="/candidates"
                        className={`${
                    ...
                    >
                        ...
                        <div className="hidden lg:block pl-1">Candidates</div>
                    </Link>
                    <Link
                        href="/positions"
                        className={`${
                    ...
                    >
                        ...
                        <div className="hidden lg:block pl-1">Positions</div>
                    </Link>
                    <Link
                        href="/events"
                        className={`${
                    ...
                    >
                        ...
                        <div className="hidden lg:block pl-1">Events</div>
                    </Link>
                </div>
