...
export type ParticipantWidgetProps = { eventId: EventsId }

export function ParticipantWidget(props: ParticipantWidgetProps) {
    ...
    return (
        <div data-testid="participant-widget" className={styles.container}>
